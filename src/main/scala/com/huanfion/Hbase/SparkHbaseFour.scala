...
object SparkHbaseFour {
  def main(args: Array[String]): Unit = {
    ...
    sc.hadoopConfiguration.set(TableOutputFormat.OUTPUT_TABLE,"orders4")
    ...
    sc.hadoopConfiguration.set("mapreduce.output.fileoutputformat.outputdir","/tmp/SparkHbaseFour")
